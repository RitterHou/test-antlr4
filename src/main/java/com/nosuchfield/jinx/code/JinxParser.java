...
public class JinxParser extends Parser {
    ...
    public static class JinxContext extends ParserRuleContext {
        public TerminalNode EOF() {
            return getToken(JinxParser.EOF, 0);
        }
    ...
    public static class VariableContext extends ParserRuleContext {
        public TerminalNode VARIABLE() {
            return getToken(JinxParser.VARIABLE, 0);
        }

        public TerminalNode ID() {
            return getToken(JinxParser.ID, 0);
        }

        public TerminalNode EQUALS() {
            return getToken(JinxParser.EQUALS, 0);
        }
    ...
    public static class PrintContext extends ParserRuleContext {
        public TerminalNode PRINT() {
            return getToken(JinxParser.PRINT, 0);
        }
    ...
    public static class ValueContext extends ParserRuleContext {
        public TerminalNode STRING() {
            return getToken(JinxParser.STRING, 0);
        }

        public TerminalNode INT() {
            return getToken(JinxParser.INT, 0);
        }

        public TerminalNode DOUBLE() {
            return getToken(JinxParser.DOUBLE, 0);
        }
